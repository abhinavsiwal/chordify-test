  ...
  return (
    <div className="w-full bg-gray-100 flex flex-col gap-4 mt-16 p-4">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-sm text-gray-700 underline font-medium ">
          Last updated: 10/08/2025 10:00 AM
        </p>
      </div>
      ...
      <div className="w-full h-full rounded-xl p-6 border border-black py-12 flex flex-col gap-6">
        ...
        <div className="w-full border border-gray-300 p-4 rounded-xl flex flex-col gap-4">
          <div className="flex items-center justify-between">
            <div className="flex flex-col gap-2">
              <h6 className="text-black text-xl font-bold">
                Funnel (Channels Aggregated)
              </h6>
              <p className="text-black text-sm">6/28/24</p>
            </div>
            <div className="flex items-center gap-6 ">
              <div className="flex gap-2 items-center">
                <ChartNoAxesColumnDecreasing
                  ...
                  strokeWidth={4}
                />
                <p className="text-gray-700 text-sm font-bold">Clicks</p>
              </div>
              <div className="flex gap-2 items-center">
                <ChartNoAxesColumnDecreasing
          ...
          <table className="w-full table-auto" >
            <tbody>
              <tr className="text-gray-400 text-sm font-medium border-b border-gray-400 " >
                <td className="py-2" >
                  6/21/24
                </td>
                <td>
